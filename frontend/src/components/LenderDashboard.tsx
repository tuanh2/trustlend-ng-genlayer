  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="gl-violet-panel p-5 rounded-2xl border border-white/10 flex items-center gap-4 relative overflow-hidden">
          <div className="w-12 h-12 rounded-xl bg-[#10B981]/20 text-[#10B981] flex items-center justify-center border border-[#10B981]/30 shrink-0">
        ...
        <div className="gl-violet-panel p-5 rounded-2xl border border-white/10 flex items-center gap-4 relative overflow-hidden">
          <div className="w-12 h-12 rounded-xl bg-[#A855F7]/20 text-[#E9D5FF] flex items-center justify-center border border-[#A855F7]/30 shrink-0">
            <DollarSign className="w-6 h-6" />
          </div>
          <div>
            <div className="text-xs text-slate-400 font-medium">Escrow Security</div>
            <div className="text-2xl font-black text-[#E9D5FF] font-mono-data">100% On-Chain</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 gl-violet-panel p-6 rounded-3xl space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-white font-syne">Create P2P Sell Order</h3>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-bold text-white font-syne">My Active Merchant Listings</h3>
            <button
